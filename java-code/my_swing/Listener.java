//www.newthinktank.com/2012/03/java-video-tutorial-21/
//https://www.youtube.com/watch?v=3ifwR5feRQI&list=PLE7E8B7F4856C9B19&index=21
/*GUI Event Handling.  
 ActionListener, KeyListener, MouseListener and 
 WindowListener.
 */
...
//---------------------------------------------------	
 public Listener(){
	this.setSize(17*FontSize, 14*FontSize); // Size of the frame 
    Font font = new Font("Courier", Font.BOLD,FontSize);
	UIManager.put("ToolTip.font",
            new FontUIResource("SansSerif", Font.BOLD, FontSize-4));
    
  // Toolkit is the super class for the 
 // Abstract Window Toolkit
 // It allows us to ask questions of the OS
				
 Toolkit tk = Toolkit.getDefaultToolkit();
				
 // A Dimension can hold the width and 
 //height of a component
 // getScreenSize returns the size of the 
 //screen
 ...
 // You could also define the x, y position
 //of the frame
 ...
 private class ListenForButton implements ActionListener{
     ...
     public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource() == button1){
                   ...
                   //textArea1.append(e.getSource().toString()); //returns information
                     
          }//if
       }//actionPerformed
 }//class ListenForButton

 
 
 // KeyListener to track keys on the keyboard
