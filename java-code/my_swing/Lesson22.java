...
public Lesson22(){
 ...
 // The ListenForButton class  defind at the end of this file 210
...
//---------------------------------------
 ...
 // Defines that you want to format a number with $ and commas
      ...
      JOptionPane.showMessageDialog(
		   Lesson22.this,  msg,  "Solution", 
		   JOptionPane.INFORMATION_MESSAGE);
  } 
 // comma is selected in the checkbox print  number with commas
    ...
    // Defines that you want to format a number with commas
       ...
       msg.setText( numFormat.format(totalCalc));
	    JOptionPane.showMessageDialog(Lesson22.this, 
		 ...
		 JOptionPane.showMessageDialog(Lesson22.this, 
				 msg, "Solution",  JOptionPane.INFORMATION_MESSAGE);
		 }
     }
  }//public void actionPerformed(ActionEvent e)
 }//private class ListenForButton implements ActionListener
